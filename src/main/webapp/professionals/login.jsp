...
<html>
<head>
    <title>Professional Login - JobQuest</title>
...
<body class="bg-gray-50">
    <div class="min-h-screen flex items-center justify-center">
        <div class="max-w-md w-full space-y-8 p-8 bg-black text-white rounded-lg shadow border-2 border-black">
            <div>
                <h2 class="text-center text-3xl font-bold text-white">Professional Sign In</h2>
                <p class="mt-2 text-center text-sm text-gray-400">
                    Or
                    <a href="/professionals/register" class="font-medium text-yellow-500 hover:text-yellow-400">
